...
public class Patisserie {
	...
	public static void main(String[] args) throws IOException {
		...
		int citronrate = (int) ((250 * citronBuyCount) / totalPrice * 100);
		int chocolaterate = (int) ((280 * chocolatBuyCount) / totalPrice * 100);
		int pistacherate = (int) ((320 * pistacheBuyCount) / totalPrice * 100);

		System.out.println("\nシトロンの味　・・・" + citronrate + "%");
		System.out.println("ショコラの味　・・・" + chocolaterate + "%");
