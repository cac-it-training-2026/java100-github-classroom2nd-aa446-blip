...
public class Patisserie {
	...
	public static void main(String[] args) throws IOException {
		...
		int citronrest = (int) (citronStock - citronBuyCount);
		int chocolaterest = (int) (chocolatStock - chocolatBuyCount);
		int pistasherest = (int) (pistacheStock - pistacheBuyCount);

		System.out.println("\n本日のおすすめ商品です。\n");
		System.out.println("シトロン    \\250・・・残り" + citronrest + "個");
		System.out.println("ショコラ    \\280・・・残り" + chocolaterest + "個");
		System.out.println("ピスターシュ\\320・・・残り" + pistasherest + "個");
	}
}
